...
[2.1.2](https://github.com/chewymole/cfcGenerator/releases/tag/v2.1.2):
Updates to configuration system. Added config variables for the Languages and Database types

[2.1.0](https://github.com/chewymole/cfcGenerator/releases/tag/v2.1.0):
...
[2.0.0](https://github.com/chewymole/cfcGenerator/releases/tag/2.0.1):
